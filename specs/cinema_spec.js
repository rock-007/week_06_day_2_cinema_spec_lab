...
describe('Cinema', function () {
  ...
  it('should be able to find a film by title', function () {
    const actual = cinema.searchFilm(moonlight.title);
  ...
  it('should be able to filter films by year_1', function(){
